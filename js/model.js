...
function changeFilter(property, value) {
...
function loadFilter() {
	let filter = { products: 'all', status: 'all', }
	...
	// localStorage.getItem('filter') ? filter = JSON.parse(localStorage.getItem('filter')) : filter = { products: 'all', status: 'all', };
...
function loadRequests() {
	return localStorage.getItem('requests') !== null ? JSON.parse(localStorage.getItem('requests')) : [];
}
